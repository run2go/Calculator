// -*- C++ -*-
//
// generated by wxGlade 1.0.5 on Mon Feb 12 08:53:42 2024
//
...
CalculatorFrame::CalculatorFrame(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    radio_btn_base64 = new wxRadioButton(this, 264, wxT("Base64"));
    ...
    radio_btn_base16 = new wxRadioButton(this, 216, wxT("Hex 16"));
    ...
    radio_btn_base10 = new wxRadioButton(this, 210, wxT("Dec 10"));
    ...
    radio_btn_base2 = new wxRadioButton(this, 202, wxT("Bin    2"));
...
EVT_RADIOBUTTON(264, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(216, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(210, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(202, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
