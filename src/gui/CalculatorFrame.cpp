// -*- C++ -*-
//
// generated by wxGlade 1.0.5 on Fri Feb  9 17:00:23 2024
//
...
#include "ButtonIds.h" // "Keep user code". Duh.
...
CalculatorFrame::CalculatorFrame(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    label_eval = new wxStaticText(this, wxID_ANY, wxT("123*(1243^2)"));
    ...
    wxStaticText *label_symbol = new wxStaticText(this, wxID_ANY, wxT(">"));
    ...
    wxStaticText *label_input = new wxStaticText(this, wxID_ANY, wxT("0"));
    ...
    radio_btn_base64 = new wxRadioButton(this, wxID_ANY, wxT("Base64"));
    ...
    button_base64 = new wxButton(this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxBU_LEFT);
    ...
    radio_btn_base16 = new wxRadioButton(this, wxID_ANY, wxT("Hex 16"));
    ...
    button_base16 = new wxButton(this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxBU_LEFT);
    ...
    radio_btn_base10 = new wxRadioButton(this, wxID_ANY, wxT("Dec 10"));
    ...
    button_base10 = new wxButton(this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxBU_LEFT);
    ...
    radio_btn_base2 = new wxRadioButton(this, wxID_ANY, wxT("Bin    2"));
    ...
    button_base2 = new wxButton(this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxBU_LEFT);
    ...
    button_num_a = new wxButton(this, ButtonIds::NUM_A, wxT("A"));
    ...
    button_delete = new wxButton(this, ButtonIds::BT_DELETE, wxT("Delete"));
    ...
    button_clear = new wxButton(this, ButtonIds::BT_CLEAR, wxT("Clear"));
    ...
    sizer_buttons->Add(0, 0, 0, 0, 0);
    button_copy = new wxButton(this, ButtonIds::BT_COPY, wxT("📋"));
    ...
    button_num_b = new wxButton(this, ButtonIds::NUM_B, wxT("B"));
    ...
    button_symbol_bracket_open = new wxButton(this, ButtonIds::SYM_BRACKET_OPEN, wxT("("));
    ...
    button_symbol_bracket_close = new wxButton(this, ButtonIds::SYM_BRACKET_CLOSE, wxT(")"));
    ...
    button_symbol_pow = new wxButton(this, ButtonIds::SYM_POW, wxT("^"));
    ...
    button_symbol_sqrt = new wxButton(this, ButtonIds::SYM_SQRT, wxT("√"));
    ...
    button_factorial = new wxButton(this, ButtonIds::SYM_FACTORIAL, wxT("n!"));
    ...
    button_num_c = new wxButton(this, ButtonIds::NUM_C, wxT("C"));
    ...
    button_num_7 = new wxButton(this, ButtonIds::NUM_7, wxT("7"));
    ...
    button_negate = new wxButton(this, ButtonIds::SYM_NEGATE, wxT("±"));
    ...
    button_num_d = new wxButton(this, ButtonIds::NUM_D, wxT("D"));
    ...
    button_reciprocal = new wxButton(this, ButtonIds::SYM_RECIPROCAL, wxT("1/n"));
    ...
    button_num_e = new wxButton(this, ButtonIds::NUM_E, wxT("E"));
    ...
    button_pi = new wxButton(this, ButtonIds::SYM_PI, wxT("π"));
    ...
    button_num_f = new wxButton(this, ButtonIds::NUM_F, wxT("F"));
    ...
    button_comma = new wxButton(this, ButtonIds::SYM_COMMA, wxT(","));
    ...
    button_percent = new wxButton(this, ButtonIds::SYM_PERCENT, wxT("%"));
...
EVT_RADIOBUTTON(wxID_ANY, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(wxID_ANY, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(wxID_ANY, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_RADIOBUTTON(wxID_ANY, CalculatorFrame::OnBaseSelection)
EVT_BUTTON(wxID_ANY, CalculatorFrame::OnBaseCopy)
EVT_BUTTON(ButtonIds::NUM_A, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::BT_DELETE, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::BT_CLEAR, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::BT_COPY, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_B, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_BRACKET_OPEN, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_BRACKET_CLOSE, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_POW, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_SQRT, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_FACTORIAL, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_C, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_7, CalculatorFrame::OnButtonPressed)
...
EVT_BUTTON(ButtonIds::SYM_NEGATE, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_D, CalculatorFrame::OnButtonPressed)
...
EVT_BUTTON(ButtonIds::SYM_RECIPROCAL, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_E, CalculatorFrame::OnButtonPressed)
...
EVT_BUTTON(ButtonIds::SYM_PI, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::NUM_F, CalculatorFrame::OnButtonPressed)
EVT_BUTTON(ButtonIds::SYM_COMMA, CalculatorFrame::OnButtonPressed)
...
EVT_BUTTON(ButtonIds::SYM_PERCENT, CalculatorFrame::OnButtonPressed)
// end wxGlade
END_EVENT_TABLE();
